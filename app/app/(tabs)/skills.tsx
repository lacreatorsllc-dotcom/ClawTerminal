...
const styles = StyleSheet.create({
  ...
  categoryChipTextActive: { color: Colors.accentPurple, fontWeight: '700' },
  ...
  badge: { backgroundColor: 'rgba(168,85,247,0.08)', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4 },
  badgeText: { color: Colors.accentPurple, fontSize: 11, fontWeight: '600', letterSpacing: 0.5 },
