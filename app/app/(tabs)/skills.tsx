...
const styles = StyleSheet.create({
  ...
  sourceChipClawhubActive: { backgroundColor: 'rgba(0,200,150,0.12)', borderColor: '#00c896' },
  sourceChipClawhubTextActive: { color: '#00c896' },
  ...
  sourceLabelClawhub: { fontSize: 11, fontWeight: '700', color: '#00c896', letterSpacing: 0.3 },
