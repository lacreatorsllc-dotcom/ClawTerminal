...
import { subscribeToDirectThreads } from '../../lib/firebase'
          ...
          {threads.length === 0 ? (
            ...
            threads.map((thread) => (
              <TouchableOpacity
                ...
                activeOpacity={0.85}
                onPress={() => router.push({ pathname: '/messages/[threadId]', params: { threadId: thread.id, otherUid: thread.other_user?.id, username: thread.other_user?.username } })}
              >
